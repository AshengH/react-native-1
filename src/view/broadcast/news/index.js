...
import { FALL, RAISE, LINE_COLOR, DATE_FONT_COLOR, NOTICE_CONTENT_FONT_COLOR } from '../../../lib/color';
    ...
    _renderTableHeader(){
        ...
        return(
            <View style={liveInformationStyle.dateRoot}>
                ...
                <Text style={[liveInformationStyle.dateText,{fontSize:15}]}>{this.state.date && this.state.date.month}月{this.state.date && this.state.date.day}</Text>
            </View>
        )
    }
